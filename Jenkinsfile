pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/eschenea'                                                                    //<------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/esch-mi/225-lab3-5.git'                                          //<------change this
        KUBECONFIG = credentials('Eschenea-225-sp26')                                                         //<------change this
    }
